...
ScaleFactor = 1/(2^(NumMultiResSteps-1)); %(1/8), (1/4), (1/2), (1)
    ...
    NewAngleIncrement = AngleIncrement;
...
for MultiResStepIndex = 1:NumMultiResSteps
    ...
    if MultiResStepIndex == 1
         AnglesInDegreesToTryArray = [CenterAngle-2*NewAngleIncrement, CenterAngle-NewAngleIncrement,  CenterAngle,   CenterAngle+NewAngleIncrement ,   CenterAngle+2*NewAngleIncrement];
    ...
    NewAngleIncrement = NewAngleIncrement/2;
