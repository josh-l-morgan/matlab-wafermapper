...
if IsPerformAutoStig
    ...
    if focOptions.IsDoQualCheck
        ...
        if (abs(AutoWorkingDistance - CurrentWorkingDistance) > (WDResetThreshold) %NOTE: this was hard-coded at a value 3 times the normal threshold size (0.5mm).  Not sure why.
