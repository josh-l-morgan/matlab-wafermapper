...
h_fig = figure();
imshow(SectionOverviewTemplate);
colormap gray(256)
...
%     [J,rect] = imcrop(SectionOverviewTemplate);
%     UpLeftCorner_C = floor(rect(1));
%     UpLeftCorner_R = floor(rect(2));
%     LowerRightCorner_C = floor(rect(1)+rect(3));
%     LowerRightCorner_R = floor(rect(2)+rect(4));
%     
