function[groupTiles, focusPoints] = Focus_9square(listStageX_Meters,listStageY_Meters,allTiles,listTakeImage)%(RowDistanceBetweenTileCentersInMicrons, ColDistanceBetweenTileCentersInMicrons, SaveDir)
