function varargout = MontageParametersGUI_backup(varargin)
% MONTAGEPARAMETERSGUI_BACKUP MATLAB code for MontageParametersGUI_backup.fig
%      MONTAGEPARAMETERSGUI_BACKUP, by itself, creates a new MONTAGEPARAMETERSGUI_BACKUP or raises the existing
%      singleton*.
%
%      H = MONTAGEPARAMETERSGUI_BACKUP returns the handle to a new MONTAGEPARAMETERSGUI_BACKUP or the handle to
%      the existing singleton*.
%
%      MONTAGEPARAMETERSGUI_BACKUP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MONTAGEPARAMETERSGUI_BACKUP.M with the given input arguments.
%
%      MONTAGEPARAMETERSGUI_BACKUP('Property','Value',...) creates a new MONTAGEPARAMETERSGUI_BACKUP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before MontageParametersGUI_backup_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to MontageParametersGUI_backup_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help MontageParametersGUI_backup

% Last Modified by GUIDE v2.5 22-Dec-2021 14:47:43

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @MontageParametersGUI_backup_OpeningFcn, ...
                   'gui_OutputFcn',  @MontageParametersGUI_backup_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MontageParametersGUI_backup is made visible.
function MontageParametersGUI_backup_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MontageParametersGUI_backup (see VARARGIN)

% Choose default command line output for MontageParametersGUI_backup
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes MontageParametersGUI_backup wait for user response (see UIRESUME)
...
set(handles.IBSC_Do_checkbox ,'Value',GuiGlobalsStruct.MontageParameters.IBSC_Do)
set(handles.IBSC_AutoFoc_checkbox ,'Value', GuiGlobalsStruct.MontageParameters.IBSC_AutoFoc)
set(handles.UseManuallyCorrectedPositionFiles_checkBox,'Value',GuiGlobalsStruct.MontageParameters.UseManuallyCorrectedPositionFiles);
set(handles.imageDirectory_edit,'String',GuiGlobalsStruct.TempImagesDirectory)
set(handles.delayStig_edit,'String',num2str(GuiGlobalsStruct.MontageParameters.delayStigHours))
...
set(handles.FocusDelay_edit47,'String',num2str(GuiGlobalsStruct.MontageParameters.focusDelay));
set(handles.invertIBSC_checkbox7,'Value',GuiGlobalsStruct.MontageParameters.invertIBSC);
...
function varargout = MontageParametersGUI_backup_OutputFcn(hObject, eventdata, handles) 
...
if ~isempty(Value) && (Value >= 10) && (Value <= 3276800)
...
GuiGlobalsStruct.MontageParameters.Is4square
...
function FocusDelay_edit47_Callback(hObject, eventdata, handles)
% hObject    handle to FocusDelay_edit47 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of FocusDelay_edit47 as text
%        str2double(get(hObject,'String')) returns contents of FocusDelay_edit47 as a double
global GuiGlobalsStruct;

ValueString = get(handles.FocusDelay_edit47,'String');
Value = str2num(ValueString);

if ~isempty(Value) && (Value >= 0) && (Value <= 10000)
    GuiGlobalsStruct.MontageParameters.AFTestImageDwellTime_microseconds = Value;
else
    uiwait(msgbox('Illegal value. Not updating.'));
end
...
GuiGlobalsStruct.MontageParameters.focusDelay = Value;

UpdateAllFields(handles);

% --- Executes during object creation, after setting all properties.
function FocusDelay_edit47_CreateFcn(hObject, eventdata, handles)
% hObject    handle to FocusDelay_edit47 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in invertIBSC_checkbox7.
function invertIBSC_checkbox7_Callback(hObject, eventdata, handles)
% hObject    handle to invertIBSC_checkbox7 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of invertIBSC_checkbox7
global GuiGlobalsStruct;

Value = get(handles.invertIBSC_checkbox7,'Value');
GuiGlobalsStruct.MontageParameters.invertIBSC = Value;

UpdateAllFields(handles);


% --- Executes during object creation, after setting all properties.
function invertIBSC_checkbox7_CreateFcn(hObject, eventdata, handles)
% hObject    handle to invertIBSC_checkbox7 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in IBSC_Do_checkbox.
function IBSC_Do_checkbox_Callback(hObject, eventdata, handles)
% hObject    handle to IBSC_Do_checkbox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of IBSC_Do_checkbox
global GuiGlobalsStruct
GuiGlobalsStruct.MontageParameters.IBSC_Do = get(hObject,'Value');

% --- Executes on button press in IBSC_AutoFoc_checkbox.
function IBSC_AutoFoc_checkbox_Callback(hObject, eventdata, handles)
% hObject    handle to IBSC_AutoFoc_checkbox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of IBSC_AutoFoc_checkbox
global GuiGlobalsStruct
GuiGlobalsStruct.MontageParameters.IBSC_AutoFoc = get(hObject,'Value');
...
% --- Executes on button press in UseManuallyCorrectedPositionFiles_checkBox.
function UseManuallyCorrectedPositionFiles_checkBox_Callback(hObject, eventdata, handles)
% hObject    handle to UseManuallyCorrectedPositionFiles_checkBox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of UseManuallyCorrectedPositionFiles_checkBox
global GuiGlobalsStruct
GuiGlobalsStruct.MontageParameters.UseManuallyCorrectedPositionFiles = get(hObject,'Value');


% --- Executes on button press in ImageDirectory_pushbutton.
function ImageDirectory_pushbutton_Callback(hObject, eventdata, handles)
% hObject    handle to ImageDirectory_pushbutton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global GuiGlobalsStruct
imageDirectory = GetMyDir; 
GuiGlobalsStruct.TempImagesDirectory = imageDirectory(1:end-1);
set(handles.imageDirectory_edit,'String',GuiGlobalsStruct.TempImagesDirectory)

function imageDirectory_edit_Callback(hObject, eventdata, handles)
% hObject    handle to imageDirectory_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of imageDirectory_edit as text
%        str2double(get(hObject,'String')) returns contents of imageDirectory_edit as a double
global GuiGlobalsStruct
str = get(handles.imageDirectory_edit,'String')
GuiGlobalsStruct.TempImagesDirectory = str;


% --- Executes during object creation, after setting all properties.
function imageDirectory_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to imageDirectory_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function delayStig_edit_Callback(hObject, eventdata, handles)
% hObject    handle to delayStig_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of delayStig_edit as text
%        str2double(get(hObject,'String')) returns contents of delayStig_edit as a double
global GuiGlobalsStruct
str = get(hObject,'String')
GuiGlobalsStruct.MontageParameters.delayStigHours = str2num(str);

% --- Executes during object creation, after setting all properties.
function delayStig_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to delayStig_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function selectSections_edit_Callback(hObject, eventdata, handles)
% hObject    handle to selectSections_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of selectSections_edit as text
%        str2double(get(hObject,'String')) returns contents of selectSections_edit as a double

global GuiGlobalsStruct

str = get(hObject,'String');
manualRetakeList = str2num(str);
TPN = GuiGlobalsStruct.TempImagesDirectory;
save([TPN '\manualRetakeList.mat'],'manualRetakeList');


% --- Executes during object creation, after setting all properties.
function selectSections_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to selectSections_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in AllSections_pushbutton.
function AllSections_pushbutton_Callback(hObject, eventdata, handles)
% hObject    handle to AllSections_pushbutton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
L = length(GuiGlobalsStruct.CoarseSectionList);
str = sprintf('1:%d',L);
set(handles.selectSections_edit,'String',str);
