...
% Last Modified by GUIDE v2.5 21-Sep-2022 11:18:02
...
imwrite(uint8(SectionMaskGuiGlobals.FullMapImage),FullMapImage_Thresholded_FileNameStr,'tif'); 
...
disp(MyStr);
imwrite(uint8(SectionMaskGuiGlobals.SubImageForTemplateThresholded),ExampleSectionImage_Thresholded_FileNameStr,'tif'); 
...
% --- Executes on button press in pushbutton_invertContrast.
function pushbutton_invertContrast_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_invertContrast (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
SubImageForTemplateFileNameStr = sprintf('%s\\ExampleSectionImageCropped.tif',GuiGlobalsStruct.ExampleSectionImageDirectory);
SubImageForTemplate = imread(SubImageForTemplateFileNameStr,'tif');
SubImageForTemplate = 255 - SubImageForTemplate;
imwrite(SubImageForTemplate,SubImageForTemplateFileNameStr);
...
function edit_posSig_Callback(hObject, eventdata, handles)
% hObject    handle to edit_posSig (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_posSig as text
%        str2double(get(hObject,'String')) returns contents of edit_posSig as a double


% --- Executes during object creation, after setting all properties.
function edit_posSig_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_posSig (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function edit_negSig_Callback(hObject, eventdata, handles)
% hObject    handle to edit_negSig (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_negSig as text
%        str2double(get(hObject,'String')) returns contents of edit_negSig as a double


% --- Executes during object creation, after setting all properties.
function edit_negSig_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_negSig (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% hObject    handle to pushbutton_applyFilter (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
%%Get Gaussian paramets
str = get(handles.edit_posSig,'String');
s1 = str2num(str);
str = get(handles.edit_negSig,'String');
s2 = str2num(str);
...
if s1
I = double(SubImageForTemplate);


kSize = max([s1 s2])*2;

k1 = fspecial('gaussian',kSize,s1);
k1= k1/sum(k1(:));
f1 = imfilter(I,k1,'symmetric');

if s2
k2 = fspecial('gaussian',kSize,s2);
k2 = k2/sum(k2(:));
f2 = imfilter(I,k2,'symmetric');
If = f1-f2;
else
    If = f1;
end
...
% --- Executes on button press in pushbutton_saveFiltered.
function pushbutton_saveFiltered_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_saveFiltered (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
SubImageForTemplateFileNameStr = sprintf('%s\\ExampleSectionImageCropped.tif',GuiGlobalsStruct.ExampleSectionImageDirectory);
SubImageForTemplate = imread(SubImageForTemplateFileNameStr,'tif');
imwrite(SectionMaskGuiGlobals.SubImageForTemplate,SubImageForTemplateFileNameStr);



% --- Executes on button press in pushbutton_resetExample.
function pushbutton_resetExample_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_resetExample (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
