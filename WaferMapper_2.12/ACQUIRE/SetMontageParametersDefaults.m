...
GuiGlobalsStruct.MontageParameters.focusDelay = 0;
GuiGlobalsStruct.MontageParameters.invertIBSC = 0;

GuiGlobalsStruct.MontageParameters.IBSC_Do = 1;
GuiGlobalsStruct.MontageParameters.IBSC_AutoFoc = 0;
GuiGlobalsStruct.MontageParameters.UseManuallyCorrectedPositionFiles = 0;
GuiGlobalsStruct.TempImagesDirectory = '';
GuiGlobalsStruct.MontageParameters.delayStigHours = 0;
